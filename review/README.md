...
GitHub Actions 的 structural check 会自动检查 nbformat、Python syntax、20 个 Notebook 的文档链接和审查资产；它不代替本地的全量 code-cell 执行。涉及模型或依赖的变更，仍需在本地运行 CPU smoke test，并把结果写进 PR 或审查报告。
